...
class Decoder(Module):
    ...
    def __init__(self, d_hidden: int = 256, conv_chans: int = 1024, n_mel_chans: int = 80, kernel_size: int = 9, 
        ...
        single_layer = DecoderLayer(
            d_hidden=d_hidden, conv_chans=conv_chans, kernel_size=kernel_size, n_heads=n_heads, dropout=dropout, eps=eps
        )
